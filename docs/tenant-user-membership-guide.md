...
> Answers: _What is a tenant? How do I register OrganizationZ? How do users and memberships work?_
...
### Phase A — Tenant Provisioning _(Platform creates the organization)_
...
_Next implementation: Tenant self-registration API + User/Membership sync on first Keycloak login._
